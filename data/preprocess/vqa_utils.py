...
from data.preprocess.vqa_preprocessors import VQADataset
...
class DataUtils(object):
    ...
    def _build_dataloader(self):
        ...
        self.train_dataset = VQADataset(
            self.hparams,
            self.hparams.questions_json % "train2014",
            self.hparams.annotations_json % "train2014",
        ...
        self.valid_dataset = VQADataset(
            self.hparams,
            self.hparams.questions_json % "val2014",
            self.hparams.annotations_json % "val2014",
            overfit=self.hparams.overfit,
        )
        ...
        self.test_dataset = VQADataset(
            self.hparams,
            self.hparams.questions_json % "test2015",
            overfit=self.hparams.overfit,
        )
...
if __name__ == '__main__':
    ...
    if not os.path.isdir("data/vqa_v2_text"):
        os.mkdir("data/vqa_v2_text")
    
    data_utils = DataUtils()
    
    h5_path = "data/vqa_v2_text/vqa_v2_text_%s.hdf5"
